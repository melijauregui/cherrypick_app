...
csv_filename = "datasets/fashion_data.csv"
df = pd.read_csv(csv_filename)
model = AutoModel.from_pretrained(
    "melijauregui/fashionSigLIP-roturas", trust_remote_code=True).to(device)
...
df.dropna(subset=['image_embedding', 'text_embedding',
