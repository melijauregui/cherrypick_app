...
fine_tune(csv_path="datasets/con-sin-roturas.csv", original_model_name=ORIGINAL_MODEL_NAME, model_name=ORIGINAL_MODEL_NAME,
          model_name_to_push="Sofia-gb/fashionclip-roturas3", batch_size=32, epochs=15)
