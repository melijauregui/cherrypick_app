...
const { PINECONE_API_KEY, PINECONE_INDEX_NAME, PINECONE_HOST_NAME, PINECONE_NAMESPACE, ANDROID_CLIENT_ID, IOS_CLIENT_ID} = process.env;
const REQUIRED_VARS = { PINECONE_API_KEY, PINECONE_INDEX_NAME, PINECONE_HOST_NAME, PINECONE_NAMESPACE, ANDROID_CLIENT_ID, IOS_CLIENT_ID};
